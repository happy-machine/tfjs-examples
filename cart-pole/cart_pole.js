...
import * as tf from '@tensorflow/tfjs';
 ...
 //   - theta: The angle of the pole (in radians). A value of 0 corresponds to a vertical position.
...
export class CartPole {
  ...
  update(action) {
   ...
   // Determine whether this simulation is done. when `x` (position of the cart) goes out of bound
